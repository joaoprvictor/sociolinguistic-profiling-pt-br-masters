...
response = data$count_diminutive
response
...
# =============================================
# comparing models
summary(model_no_interaction_poisson)
summary(model_with_interaction_poisson)
...
anova(model_no_interaction_poisson, model_with_interaction_poisson,model_no_interaction_nb, test = "Chisq")

# ========================

# NO INTERACTION
### analysing the levels in SEX
m_means <- emmeans(model_no_interaction_poisson, ~ sex)
...
m_means <- emmeans(model_no_interaction_poisson, ~ age)
cld(m_means, Letters = letters)
#### BASIC PLOT
emmip(m_means, ~ age) 
####BASIC PLOT WITH CONFIDENCE LIMITS
...
m_means <- emmeans(model_no_interaction_poisson, ~ schooling)
cld(m_means, Letters = letters)
#### BASIC PLOT
